...
<div class="row justify-content-sm-center">
    <div class="col-sm-9 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/rigid-piston-direct-radiation.svg" title="Rigid piston direct radiation" alt="Diagram of rigid piston direct radiation pattern for audio beam generation" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-9 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/loudspeaker-direct-radiation.svg" title="Conventional loudspeaker direct radiation" alt="Conventional loudspeaker showing impractical size needed for directional audio beam" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-9 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/parametric-acoustic-array-westervelt.png" title="Parametric acoustic array concept" alt="Westervelt parametric acoustic array concept showing nonlinear interaction of ultrasound waves" class="img-fluid" %}
    </div>
</div>
...
<div class="row justify-content-sm-center">
    <div class="col-sm-9 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/rigid-piston-pal-ultra.svg" title="Rigid piston ultrasound beam" alt="Collimated ultrasound beam generated by a rigid piston transducer" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-9 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/rigid-piston-pal-audio.svg" title="Directional audio beam via parametric array" alt="Highly directional audio beam produced by nonlinear interaction of ultrasound in air" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/parametric-array.svg" title="Virtual end-fire line source" alt="Parametric array forming a virtual end-fire line source in air" class="img-fluid" %}
        <div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-3 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/rigid-piston.svg" title="rigid piston" alt="Ideal rigid piston radiator schematic" %}
        <div class="caption">
            Ideal rigid piston.
        </div>
    </div>
    <div class="col-sm-3 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/phased-array.svg" title="phased array" alt="Conventional phased array parametric array loudspeaker with multiple emitters" %}
        <div class="caption">
            Conventional array-based PAL utilizing multiple phase-synchronized emitters.
        </div>
    </div>
    <div class="col-sm-3 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/flexural-plate.svg" title="flexural plate" alt="Single-body flexural plate radiator for compact PAL design" %}
        <div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-9 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/flexural-plate-radiation.svg" title="Flexural plate radiation pattern" alt="Off-axis incoherent radiation pattern of a high-order flexural-mode plate" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/sppal-concept.svg" title="SPPAL concept" alt="Stepped-plate parametric array loudspeaker concept with phase-compensating annular steps" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-9 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/sppal-ultra.svg" title="SPPAL ultrasonic wavefront" alt="Phase-compensated coherent ultrasonic wavefront generated by the SPPAL" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-9 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/sppal-audio.svg" title="SPPAL directional audio beam" alt="Directional audio beam generated by the stepped-plate parametric array loudspeaker" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-9 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/sppal-combination-resonance.svg" title="SPPAL combination resonance" alt="Vibration modes showing intended ultrasonic mode and parasitic combination resonance in the stepped plate" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
- Extensive [vibration]({% link _projects/mech_vibraction_characterization.md %}) and [acoustic measurements]({% link _projects/aco_field_characterization.md %}), run on a fully automated and synchronized test setup, **systematically identified CR for the first time** as an intrinsic structural limitation of single-body flexural transducers.
...
<div class="row justify-content-sm-center">
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/mipal-concept.svg" title="MiPAL concept" alt="Metamaterials-integrated parametric array loudspeaker concept with dual-domain metamaterial architecture" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-9 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/mipal-ultra.svg" title="MiPAL ultrasound wavefront" alt="Acoustic metasurface redirecting flexural-mode radiation into collimated ultrasound wavefront" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-9 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/mipal-audio.svg" title="MiPAL directional audible sound" alt="Broadband directional audio beam from MiPAL with combination resonance suppressed" class="img-fluid" %}
    </div>
</div>
<div class="caption">
...
<div class="row justify-content-sm-center">
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/mipal-aco-meta.svg" title="Acoustic metasurface unit-cells" alt="Acoustic metasurface unit-cells with Helmholtz resonators and space-coiling channels for phase modulation" %}
        <div class="caption">
    ...
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/project/parametric-array-loudspeaker/mipal-ela-meta.svg" title="Locally resonant elastic meta-units" alt="Locally resonant elastic meta-units embedded on radiating plate for mode-selective vibration suppression" %}
        <div class="caption">
